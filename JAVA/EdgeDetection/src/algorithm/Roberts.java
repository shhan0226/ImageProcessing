...
public class Roberts {
	...
	public Roberts(BufferedImage imageIn) {
		init(imageIn);
	...
	public void EdgeStart() {
		...
		for (int j = 1; j < imgHeight - 1; j++) {
			for (int i = 1; i < imgWidth - 1; i++) {
				...
				int gx = ((-1 * val00) + (0 * val01) + (0 * val02)) + ((0 * val10) + (1 * val11) + (0 * val12))
						+ ((0 * val20) + (0 * val21) + (0 * val22));

				int gy = ((0 * val00) + (0 * val01) + (0 * val02)) + ((0 * val10) + (1 * val11) + (0 * val12))
						+ ((-1 * val20) + (0 * val21) + (0 * val22));
